        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card bg-dark text-white">
                    <div class="card-header text-center">{{ __('documentUpload.edit_document') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('documents.update', ['locale' => app()->getLocale(), 'id' => $document->id]) }}"
                                ...
                                <div class="col-md-6">
                                    <select name="owner_code" id="owner_code"
                                        ...
                                        @foreach(__('documentUpload.units') as $code => $name)
                                            <option value="{{ $code }}" {{ $document->owner_code == $code ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="doc_type_code" id="doc_type_code"
                                        ...
                                        <optgroup label="{{ __('documentUpload.system_docs') }}">
                                            @foreach(['PS', 'PR', 'IN', 'FR'] as $code)
                                                <option value="{{ $code }}" {{ $document->doc_type_code == $code ? 'selected' : '' }}>
