    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card bg-dark text-white">
                ...
                <div class="card-body">
                    <form
                        action="{{ route('categories.update', ['locale' => app()->getLocale(), 'category' => $category->id]) }}"
                        ...
                        <div class="row mb-3">
                            <label for="name_en"
                                class="col-md-4 col-form-label text-md-end">{{ __('categoryEdit.category_name_en') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="name_fa"
                                class="col-md-4 col-form-label text-md-end">{{ __('categoryEdit.category_name_fa') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="page_name"
                                class="col-md-4 col-form-label text-md-end">{{ __('categoryEdit.page_name') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="description_en"
                                class="col-md-4 col-form-label text-md-end">{{ __('categoryEdit.description_en') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="description_fa"
                                class="col-md-4 col-form-label text-md-end">{{ __('categoryEdit.description_fa') }}</label>
                            <div class="col-md-6">
