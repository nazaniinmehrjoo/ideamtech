...
<div class="container mt-5">
        ...
        <div class="col-md-4">
            <div class="card stat-box border-success">
                ...
                <div class="card-body">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-success" role="progressbar" style="width: {{ ($completedProjects / max($totalProjects, 1)) * 100 }}%" aria-valuenow="{{ ($completedProjects / max($totalProjects, 1)) * 100 }}" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card stat-box border-warning">
                ...
                <div class="card-body">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-warning" role="progressbar" style="width: {{ ($ongoingProjects / max($totalProjects, 1)) * 100 }}%" aria-valuenow="{{ ($ongoingProjects / max($totalProjects, 1)) * 100 }}" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <input type="text" id="projectSearch" class="form-control mb-3" placeholder="جستجو پروژه‌ها..." onkeyup="searchProjects()">
    ...
    <!-- Map and Project Progress Chart -->
    <div class="row mt-5">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
    ...
    <div class="row mt-5">
    <div class="col-md-12">
        <h3 class="text-white">نظر مشتریان ما</h3>
        <div id="testimonialCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="testimonial text-center">
                        <img src="https://via.placeholder.com/80" alt="Customer 1" class="rounded-circle" width="80">
                        <p class="testimonial-text">“خدمات شرکت شما بی‌نظیر بود. نصب و راه‌اندازی به موقع و بدون مشکل انجام شد.”</p>
                        <p class="customer-name"><strong>- شرکت الف</strong></p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial text-center">
                        <img src="https://via.placeholder.com/80" alt="Customer 2" class="rounded-circle" width="80">
                        <p class="testimonial-text">“بسیار راضی هستم، پروژه ما خیلی سریع و با کیفیت بالا به اتمام رسید.”</p>
                        <p class="customer-name"><strong>- شرکت ب</strong></p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial text-center">
                        <img src="https://via.placeholder.com/80" alt="Customer 3" class="rounded-circle" width="80">
                        <p class="testimonial-text">“تجربه همکاری با شما فوق‌العاده بود. همواره از خدمات شما استفاده خواهیم کرد.”</p>
                        <p class="customer-name"><strong>- شرکت ج</strong></p>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial text-center">
                        <img src="https://via.placeholder.com/80" alt="Customer 4" class="rounded-circle" width="80">
                        <p class="testimonial-text">“با وجود چالش‌های مختلف، تیم شما به خوبی پروژه را مدیریت کرد.”</p>
