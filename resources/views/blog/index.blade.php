                    ...
                    <div class="card mb-4 shadow-sm h-100 w-100">
                        ...
                        <div class="card-body d-flex flex-column" style="height: 250px;">
                            ...
                            <div class="mt-auto d-flex justify-content-between">
                                ...
                                <a href="{{ route('blog.edit', ['locale' => app()->getLocale(), 'blog' => $post->id]) }}"
                                    class="btn btn-warning btn-sm">
                                    {{ __('blog-index.edit') }}
                                </a>
                                <form
                                    action="{{ route('blog.destroy', ['locale' => app()->getLocale(), 'post' => $post->id]) }}"
                                    method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger btn-sm"
                                        onclick="return confirm('{{ __('blog-index.delete_confirmation') }}')">
