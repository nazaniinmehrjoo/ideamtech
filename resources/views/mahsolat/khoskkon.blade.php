            ...
            <section class="page-title" id="to-top-div">
                <div class="auto-container">
                    ...
                    <div class="bread-crumb">
                        <ul class="clearfix">
                            <li><a href="/">خانه</a></li>
                            <li class="/mahsolat/mashinalatshekldehi">خشک کن</li>
                        </ul>
                    </div>
                </div>
            </section>
                    ...
                    <div class="mixitup-gallery">
                        ...
                        <div class="gallery-filters centered clearfix">
                            <ul class="filter-tabs filter-btns clearfix">
                                ...
                                <li class="filter" data-role="button" data-filter=".motion">باکس فیدر</li>
                                <li class="filter" data-role="button" data-filter=".application">آسیاب</li>
                                <li class="filter" data-role="button" data-filter=".website">سرند</li>
                                <li class="filter" data-role="button" data-filter=".mockup">مخلوط کن</li>
                                <li class="filter" data-role="button" data-filter=".branding">والس</li>
                                <li class="filter" data-role="button" data-filter=".branding">پرس</li>
