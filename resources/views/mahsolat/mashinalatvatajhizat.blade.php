            ...
            <section class="page-title" id="to-top-div">
                <div class="auto-container">
                    ...
                    <div class="bread-crumb">
                        <ul class="clearfix">
                            <li><a href="/">خانه</a></li>
                            <li class="">ماشین آلات و تجهیزات</li>
                        </ul>
                    </div>
                </div>
            </section>
                    ...
                    <div class="mixitup-gallery">
                        ...
                        <div class="gallery-filters centered clearfix">
                            <ul class="filter-tabs filter-btns clearfix">
                                ...
                                <li class="filter" data-role="button" data-filter=".motion">فن</li>
                                <li class="filter" data-role="button" data-filter=".application">مشعل</li>
                                <li class="filter" data-role="button" data-filter=".website">سیتنگ و رباتیک</li>
                                <li class="filter" data-role="button" data-filter=".mockup">زنجیرومتعلقات</li>
