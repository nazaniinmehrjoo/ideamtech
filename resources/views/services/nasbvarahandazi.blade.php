                                    ...
                                    <div class="bottom-content">
                                        <div class="auto-container">
                                            <div class="bottom-inner">
                                                ...
                                                ابتدا نقشه‌بردار با بررسی دقیق محوطه و موقعیت‌های موجود در کارخانه، نقشه اولیه را تهیه می‌کند تا تمامی جزئیات به خوبی مشخص شوند. پس از آن، با هماهنگی کامل با کارفرما، نقشه چیدمان کارخانه بر اساس طرح توسعه و با در نظر گرفتن موقعیت‌های مناسب برای ماشین‌آلات، خشک‌کن‌ و کوره‌ها ( تونلی یاهافمن) تنظیم می‌شود. در نهایت، جانمایی دقیق کارخانه و تعیین محل استقرار هر بخش توسط مهندس نقشه‌بردار انجام می‌شود تا تمامی تجهیزات به صورت بهینه در محل قرار گیرند.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
