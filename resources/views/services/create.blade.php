                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="page_name" id="page_name" class="form-control bg-dark text-white @error('page_name') is-invalid @enderror">
                                    ...
                                    <option value="parts_repairs" {{ isset($service) && $service->page_name == 'parts_repairs' ? 'selected' : '' }}>{{ __('serviceCreate.parts_repairs') }}</option>
                                    <option value="engineering" {{ isset($service) && $service->page_name == 'engineering' ? 'selected' : '' }}>{{ __('serviceCreate.engineering') }}</option>
                                    <option value="installation" {{ isset($service) && $service->page_name == 'installation' ? 'selected' : '' }}>{{ __('serviceCreate.installation') }}</option>
                                    <option value="after_sales" {{ isset($service) && $service->page_name == 'after_sales' ? 'selected' : '' }}>{{ __('serviceCreate.after_sales') }}</option>
                                </select>
                                @error('page_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
