    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card bg-dark text-white">
                ...
                <div class="card-body">
                    <!-- Form -->
                    <form action="{{ route('services.update', ['locale' => app()->getLocale(), 'service' => $service->id]) }}" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                @if($service->banner_images)
                                    <div class="mt-3">
                                        @foreach(json_decode($service->banner_images) as $image)
                                            <img src="{{ asset('storage/' . $image) }}" alt="تصویر" class="img-thumbnail" style="max-width: 100px;">
                                        @endforeach
                                    </div>
                                @endif
                            </div>
