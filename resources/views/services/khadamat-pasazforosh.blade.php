            ...
            <section class="page-title" id="to-top-div">
                <div class="auto-container">
                    ...
                    <div class="bread-crumb">
                        <ul class="clearfix">
                            <li><a href="/">خانه</a></li>
                            <li class="/khadamat-pasazforosh">خدمات پس از فروش</li>
                        </ul>
                    </div>
                </div>
            </section>
                    ...
                    <div class="mixitup-gallery">
                        ...
                        <div class="gallery-filters centered clearfix">
                            <ul class="filter-tabs filter-btns clearfix">
                                ...
                                <li class="filter" data-role="button" data-filter=".motion">دسته پنجم</li>
                                <li class="filter" data-role="button" data-filter=".application">دسته چهارم</li>
                                <li class="filter" data-role="button" data-filter=".website">دسته سوم</li>
                                <li class="filter" data-role="button" data-filter=".mockup">دسته دوم</li>
                                <li class="filter" data-role="button" data-filter=".branding">دسته اول</li>
